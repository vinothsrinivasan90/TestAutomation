...
public class EditLead {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.xpath("//div[@class='allSubSectionBlocks']//a[text()='Edit']")).click();
		driver.findElement(By.xpath("//div[@class='form']//textarea[@name='description']")).clear();
		driver.findElement(By.xpath("//div[@class='form']//textarea[@name='importantNote']")).sendKeys("Test");
		driver.findElement(By.xpath("//div[@class='allSubSectionBlocks']//input[@value='Update']")).click();
